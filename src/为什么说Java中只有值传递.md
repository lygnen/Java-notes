...
<div><img src="../photo/1.jpg"/></div><br>
...
然后在pass方法内对参数进行修改的时候，即user = new User();，会重新开辟一块0X456789的内存，赋值给user。后面对user的任何修改都不会改变内存`0X123456`的内容（图3）。
...
<div><img src="../photo/2.jpg"/></div><br>
...
<div><img src="../photo/3.jpg"/></div><br>
...
来自：Hollis（微信号：hollischuang）
<div><img src="../photo/二.jpg"/></div><br>
